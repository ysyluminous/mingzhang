      ...
      <q-toolbar class="GNL__toolbar">
        ...
        <div class="q-gutter-xs" v-if="$q.screen.gt.sm">
          <q-btn type="a" target="_blank" unelevated size="sm" dense round
                 href="https://www.yuque.com/yaoyq">
            <q-avatar size="sm">
              <q-img alt="语雀" src="imgs/logo/yuque.png" style="width: 32px" />
              <q-tooltip>
                {{$t('StandardLayout.yuQue')}}
              </q-tooltip>
            </q-avatar>
          </q-btn>
        </div>
        <div class="q-gutter-xs q-ml-sm row items-center no-wrap">
          <q-btn type="a" target="_blank" unelevated size="sm" dense round
                 href="https://gitee.com/ysygitee/ruoyi-fast-plus">
          ...
          <q-btn type="a" target="_blank" unelevated size="sm" dense round
                 href="/article/1162">
            <q-avatar size="sm" text-color="primary">
              <q-icon class="iconqq iconfont text-primary" />
              <q-tooltip v-if="$q.screen.gt.sm">
                {{$t('StandardLayout.githubAddress')}}
              </q-tooltip>
            </q-avatar>
...
<!--          </q-btn>-->
    ...
    <q-footer
      class="text-blue-grey-4 bg-grey-2 fixed-bottom"
      v-if="styleSettingsData.contentSettings.footer"
    >
      <div class="q-my-lg">
        <div class="text-center q-mb-sm">
          <a href='/article/638'>
          <span class="inline-block q-mr-sm" >免责声明</span>
          </a>

          <a href='/article/1162'>
<!--                        <q-avatar size="sm">-->
<!--                          <q-icon class="mdui-icon material-icons">&#xe7f0;</q-icon>-->
<!--                        </q-avatar>-->
          <span class="inline-block q-mr-sm" >交流群组</span>
          </a>
...
<!--        <div class="text-center">{{`Copyright@2021 清欢 ${$t('StandardLayout.experienceTheTechnicalDepartment')}`}}</div>-->
      </div>
    </q-footer>
    <q-drawer
        ...
        >
          <q-btn type="a" target="_blank" unelevated dense round
            ...
            <q-avatar style="width: 40px; height: 40px">
              <q-icon class="mdui-icon material-icons" style='color: #1890ff'>&#xe7f0;</q-icon>
<!--              <q-icon class="iconfont iconhuaban88 text-primary"/>-->
              <q-tooltip v-if="$q.screen.gt.sm">
                {{$t('StandardLayout.githubAddress')}}
              </q-tooltip>
...
<style>
@import 'https://at.alicdn.com/t/font_2136554_95kmewdgocg.css';
</style>
